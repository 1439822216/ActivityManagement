...
public class MyHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String sql1 = "create table activity(aid varchar(20) primary key ,aName varchar(50),aimageId varchar(20),aUid varchar(20),aOpenTime varchar(20), aEndTime varchar(20),aPlace varchar(30),aInfo varchar(200),aTelephone varchar(20))";
    ...
    public void insertActivity(SQLiteDatabase sqLiteDatabase){
        sqLiteDatabase.execSQL("insert into activity values('9591AD2C90404CA9B61B8D73C8AB6F3F','广州城建职业学院“蚁人团队”寒假择校资讯推广公益活动','a1.jpg','E3BF64A5C21243678CDBC4C21649C954',\n" +
                ...
                "'123456')");
        sqLiteDatabase.execSQL("insert into activity values('8837B253D2B14E4CB1C2932715722378','霞洞中学2019年元旦文艺晚会','a2.jpg','ADC80B549F2D4D1DB1E5315C1144F0BA','2018-12-27','2018-12-27 ','电白区霞洞中学','时间如白驹过隙，转眼间2019年元旦将至，为庆祝元旦佳节，也进一步推进我校文艺活动的蓬勃发展，丰富校园文化生活，活跃学习氛围，给同学们一个真正展示自我风采和勇气的舞台。2019年元旦晚会将以宏大的气魄，不凡的手笔，新颖的题材，经典的节目，集多种舞台表演形式，真实反映我校校园文化建设，以出色的工作和优异的成绩，推进我校校风学风及校园文化建设，迎接新年的到来。\n" +
                "一、活动主题：好心茂名，平安电白。\n" +
                "二、活动对象：全校学生，以班级为单位。\n" +
                "三、活动地点：学校舞台\n" +
                "四、活动时间：2018年12月27日18:00 -22:00\n" +
                "五、节目类型：1.现代舞；2.民族舞；3.小品；4.相声；5.综艺（独唱伴舞、双人唱伴舞、小组唱伴舞、乐器表演、才艺展示、时装秀、武术、健美操等，节目内容需健康向上）','123456')");
        sqLiteDatabase.execSQL("insert into activity values('2FB3BA010AED4FD2880DF20813E7E204','2019桂城青年创客墟接受报名啦！','a3.jpg','8BB3195305814946903BBFA742D1BC49','2019-01-31','2019-02-04','佛山市南海区迎春花市','1．以团队形式申报\n" +
                "2．申报团队要求：\n" +
                "（1）申报团队由4-7人组成，成员须为16周岁以上28周岁以下。（建议至少有一名懂得财务相关知识的成员）\n" +
                "（2）每人只可加入一支队伍，违者所在队伍整队取消参赛资格。\n" +
                "（3）每支队伍须确定领队人选、成员名单、申报方案等信息，方案提交后不得随意更改。\n" +
                "','123456')");
        sqLiteDatabase.execSQL("insert into activity values('8DDE027543EF4A6FAE98A6D9C94B953B','随手公益','a4.jpg','0559A1CC0D8F4CDAB3F46AF80A8ACD14','2018-12-28','2018-12-31','珠江大道','活动目的：致敬环卫工人，保护环境，爱护他人劳动成果，从我们做起。\n" +
                "活动主题：随手公益。\n" +
                "活动时间：2018-12-31  07:00-08:00。\n" +
                "活动要求 ：已收到短信通知为准。','123456')");
        sqLiteDatabase.execSQL("insert into activity values('36787A16F1624D29B2CB9F62C19B95FE','DIY折纸','a5.jpg','31F0275BBE62445681A451701826B607','2018-12-29','2018-12-31','广东省珠海市香洲区金鸡路608-127号','一.活动名称：折纸\n" +
        ...
        sqLiteDatabase.execSQL("insert into activity values('EB0D41F327A84771824B2042433462C0','二临新春晚会','a6.jpg','F192C168E2594B33BF49DCB74AF10AE4','2019-01-06','2019-01-09','南方医科大学顺德校区综合馆','一、活动主题：\n" +
                "   蔓茂医心，梦圆珠江\n" +
                "二、活动背景：\n" +
        ...
        sqLiteDatabase.execSQL("insert into activity values('64D4F80180B84955AA20790DA8B9ACEE','97中新年剧场','a7.jpg','AA3326A5654747E3878E3C34429EFEAF','2019-01-06','2019-01-08','广东省广州市海珠区金恒路75','2018学年广州市第九十七中学“我的青春我做主”\n" +
